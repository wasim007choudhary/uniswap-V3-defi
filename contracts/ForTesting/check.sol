...
library TickMath {
    ...
    uint160 internal constant MIN_SQRT_PRICE_RATIO = 4295128739;

    uint160 internal constant MAX_SQRT_PRICE_RATIO = 1461446703485210103287273052203988822378723970342;
    ...
    function getOptimzedSqrtRatioAtTick(int24 tick) internal pure returns (uint160 sqrtPriceX96) {
        uint256 absTick = tick < 0 ? uint256(-int256(tick)) : uint256(int256(tick));
